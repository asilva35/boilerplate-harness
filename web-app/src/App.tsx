...
// main.tsx, App.tsx only owns which page renders for which path. Phase 28
// adds a third, the saved-chats archive. No route needs params or nesting
// yet, so a flat Routes list is enough.
function App() {
  return (
    <Routes>
